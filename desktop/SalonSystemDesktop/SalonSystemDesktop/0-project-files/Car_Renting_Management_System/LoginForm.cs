...
namespace Car_Renting_Management_System
{
    public partial class LoginForm : Form
    {
        ...
        private async void bunifuFlatButton1_Click(object sender, EventArgs e)
        {
            ...
            var userData = new
            {
                Username = monoFlat_TextBox1.Text,
                Password = monoFlat_TextBox2.Text
            };
            ...
            try
            {
                var response = await client.PostAsync("https://localhost:7020/api/Auth/login", content);
            ...
            {
                ErrorMsgBox err = new ErrorMsgBox("Cannot connect to server.");
                err.Show();
                monoFlat_TextBox1.Text = "";
                monoFlat_TextBox2.Text = "";
                monoFlat_TrackBar1.Value = 0;
